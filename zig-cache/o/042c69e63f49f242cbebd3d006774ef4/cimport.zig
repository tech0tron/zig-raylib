...
pub const MOUSE_BUTTON_LEFT = @enumToInt(MouseButton.MOUSE_BUTTON_LEFT);
pub const MOUSE_BUTTON_RIGHT = @enumToInt(MouseButton.MOUSE_BUTTON_RIGHT);
pub const MOUSE_BUTTON_MIDDLE = @enumToInt(MouseButton.MOUSE_BUTTON_MIDDLE);
pub const MOUSE_BUTTON_SIDE = @enumToInt(MouseButton.MOUSE_BUTTON_SIDE);
pub const MOUSE_BUTTON_EXTRA = @enumToInt(MouseButton.MOUSE_BUTTON_EXTRA);
pub const MOUSE_BUTTON_FORWARD = @enumToInt(MouseButton.MOUSE_BUTTON_FORWARD);
pub const MOUSE_BUTTON_BACK = @enumToInt(MouseButton.MOUSE_BUTTON_BACK);
...
pub const MATERIAL_MAP_BRDF = @enumToInt(MaterialMapIndex.MATERIAL_MAP_BRDF);
...
pub const PIXELFORMAT_UNCOMPRESSED_R8G8B8A8 = @enumToInt(PixelFormat.PIXELFORMAT_UNCOMPRESSED_R8G8B8A8);
...
pub const Gesture = extern enum(c_int) {
    GESTURE_NONE = 0,
    GESTURE_TAP = 1,
    GESTURE_DOUBLETAP = 2,
    GESTURE_HOLD = 4,
...
pub const GESTURE_NONE = @enumToInt(Gesture.GESTURE_NONE);
pub const GESTURE_TAP = @enumToInt(Gesture.GESTURE_TAP);
pub const GESTURE_DOUBLETAP = @enumToInt(Gesture.GESTURE_DOUBLETAP);
pub const GESTURE_HOLD = @enumToInt(Gesture.GESTURE_HOLD);
pub const GESTURE_DRAG = @enumToInt(Gesture.GESTURE_DRAG);
pub const GESTURE_SWIPE_RIGHT = @enumToInt(Gesture.GESTURE_SWIPE_RIGHT);
pub const GESTURE_SWIPE_LEFT = @enumToInt(Gesture.GESTURE_SWIPE_LEFT);
pub const GESTURE_SWIPE_UP = @enumToInt(Gesture.GESTURE_SWIPE_UP);
pub const GESTURE_SWIPE_DOWN = @enumToInt(Gesture.GESTURE_SWIPE_DOWN);
pub const GESTURE_PINCH_IN = @enumToInt(Gesture.GESTURE_PINCH_IN);
pub const GESTURE_PINCH_OUT = @enumToInt(Gesture.GESTURE_PINCH_OUT);
...
pub extern fn UpdateSound(sound: Sound, data: ?*const c_void, sampleCount: c_int) void;
...
pub extern fn UpdateAudioStream(stream: AudioStream, data: ?*const c_void, frameCount: c_int) void;
...
pub const va_start = @compileError("TODO implement function '__builtin_va_start' in std.c.builtins"); // C:\Users\micha\scoop\apps\ziglang\current\lib\include\stdarg.h:17:9
pub const va_end = @compileError("TODO implement function '__builtin_va_end' in std.c.builtins"); // C:\Users\micha\scoop\apps\ziglang\current\lib\include\stdarg.h:18:9
pub const va_arg = @compileError("TODO implement function '__builtin_va_arg' in std.c.builtins"); // C:\Users\micha\scoop\apps\ziglang\current\lib\include\stdarg.h:19:9
pub const __va_copy = @compileError("TODO implement function '__builtin_va_copy' in std.c.builtins"); // C:\Users\micha\scoop\apps\ziglang\current\lib\include\stdarg.h:24:9
pub const va_copy = @compileError("TODO implement function '__builtin_va_copy' in std.c.builtins"); // C:\Users\micha\scoop\apps\ziglang\current\lib\include\stdarg.h:27:9
